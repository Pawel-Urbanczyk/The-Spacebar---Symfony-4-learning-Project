...
class Article
{
     ...
     * @Assert\NotBlank(message="Get creative and think about a title!")
     */
    private $title;
    ...
    public function incermentHeartCount(): self
    {
    ...
    public function validate(ExecutionContextInterface $context, $payload)
    {
        if(stripos($this->getTitle(), 'the borg') !== false){
          $context->buildViolation('Um... the Borg kind us nervous...')
              ->atPath('title')
              ->addViolation();
        }
    }
